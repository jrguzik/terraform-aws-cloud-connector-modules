...
## 8. Enable FIPS mode for new deployments only. Supported values are "False" or "True".
##       This setting is applied only for new deployments.
#fips_enabled                              = "False"

## 9. The number of Cloud Connector Subnets to create in sequential availability zones. Available input range 1-3 (Default: 2)
...
## 17. SSH management access from the local VPC is enabled by default (true). Uncomment if you
##     want to disable this.
##     Note: Cloud Connector will only be accessible via AWS Session Manager SSM

#mgmt_ssh_enabled                           = false

## 18. By default, a security group is created and assigned to the CC service interface(s).
...
## 19. By default, this script will apply 1 Security Group per Cloud Connector instance.
...
## 20. By default, this script will apply 1 IAM Role/Instance Profile per Cloud Connector instance.
##     Uncomment if you want to use the same IAM Role/Instance Profile for ALL Cloud Connectors (true or false. Default: false)

#reuse_iam                                  = true

## 21. By default, the VPC Endpoint Service created will auto accept any VPC Endpoint registration attempts.
##     Uncomment if you want to require manual acceptance. (true or false. Default: false)

#acceptance_required                        = true

## 22. By default, the VPC Endpoint Service is configured to auto accept any VPC Endpoint registration attempts from any principal in the current AWS Account.
...
## 23. By default, terraform will always query the AWS Marketplace for the latest Cloud Connector AMI available.
...
## 24. By default, terraform will configure Cloud Connector with EBS encryption enabled.
##     Uncomment if you want to disable ebs encryption.

#ebs_encryption_enabled                     = false

## 25. By default, EBS encryptions is set to null which uses the AWS default managed/master key.
...
## 26. By default, Terraform will create an IAM policy for Cloud Connector instance(s) per
...
## 27. By default, if Terraform is creating SGs an outbound rule is configured enabling
...
## 28. By default, ZPA dependent resources are not created. Uncomment if you want to enable ZPA configuration in your VPC
...
## 29. Provide the domain names you want Route53 to redirect to Cloud Connector for ZPA interception. Only applicable for base + zpa or zpa_enabled = true
...
## 30. By default, this script will create a new AWS VPC.
##     Uncomment if you want to deploy all resources to a VPC that already exists (true or false. Default: false)

#byo_vpc                                    = true

## 31. Provide your existing VPC ID. Only uncomment and modify if you set byo_vpc to true. (Default: null)
##     Example: byo_vpc_id = "vpc-0588ce674df615334"

#byo_vpc_id                                 = "vpc-0588ce674df615334"

## 32. By default, this script will create new AWS subnets in the VPC defined based on az_count.
...
## 33. Provide your existing Cloud Connector private subnet IDs. Only uncomment and modify if you set byo_subnets to true.
...
## 34. By default, this script will create a new Internet Gateway resource in the VPC.
...
## 35. Provide your existing Internet Gateway ID. Only uncomment and modify if you set byo_igw to true.
##     Example: byo_igw_id = "igw-090313c21ffed44d3"

#byo_igw_id                                 = "igw-090313c21ffed44d3"

## 36. By default, this script will create new Public Subnets, and NAT Gateway w/ Elastic IP in the VPC defined or selected.
...
## 37. Provide your existing NAT Gateway IDs. Only uncomment and modify if you set byo_cc_subnet to true
...
## 38. By default, this script will create new IAM roles, policy, and Instance Profiles for the Cloud Connector
##     Uncomment if you want to use your own existing IAM Instance Profiles (true or false. Default: false)

#byo_iam                                    = true

## 39. Provide your existing Instance Profile resource names. Only uncomment and modify if you set byo_iam to true

##     Example: byo_iam_instance_profile_id = ["instance-profile-1","instance-profile-2"]

#byo_iam_instance_profile_id                = ["instance-profile-1"]

## 40. By default, this script will create new Security Groups for the Cloud Connector mgmt and service interfaces
##     Uncomment if you want to use your own existing SGs (true or false. Default: false)

#byo_security_group                         = true

## 41. Provide your existing Security Group resource names. Only uncomment and modify if you set byo_security_group to true
...
## 42. By default, this script will create new route table resources associated to Cloud Connector defined private subnets
...
## 43. By default, this script will create a new VPC Endpoint Service in all availability zones specifified.
...
## 44. Provide your existing private subnet IDs to create Route53 Outbound Endpoints in.
...
## 45. By default, this script will create new route table resources associated to Route53 defined private subnets
##     Uncomment, if you do NOT want to create new route tables (true or false. Default: true)
